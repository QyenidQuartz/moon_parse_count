...
print('{}: {:0.2f}%'.format(WAXING_CRESCENT, waxing_crescent_count/lines_parsed*100))
print('{}: {:0.2f}%'.format(FIRST_QUARTER, first_quarter_count/lines_parsed*100))
print('{}: {:0.2f}%'.format(WAXING_GIBBOUS, waxing_gibbous_count/lines_parsed*100))
